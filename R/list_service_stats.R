...
list_service_stats <- function(
  service_stats_dataset = NULL,
  model_seq_years = NULL,
  division_numeric_code = NULL, # we need the unit ID added eventually to use that for filtering
