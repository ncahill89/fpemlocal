...
Fit the sub-national family planning estimation model with the function `fit_fp_c`. Set the argument `subnational` to `TRUE`. All other arguments follows from one-country examples.
```{r}
fit <- fit_fp_c(
